...
def plot_titration(collated_info, summary, colour, xlabel, protein):
    ...
    ax = plt.scatter(x=collated_info['conc_num'], y=collated_info['percent_fibs_colocalised'], c='forestgreen', alpha=0.5, linewidths=2)
...
if __name__ == "__main__":
    ...
    plot_titration(collated_info, summary, colour='forestgreen', xlabel=f'{protein} concentration', protein=protein)
