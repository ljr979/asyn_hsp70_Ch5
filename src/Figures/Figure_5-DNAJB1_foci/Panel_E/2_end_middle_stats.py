...
if __name__ == "__main__":
    ...
    inputu=('data/Figures/Figure_5/Panel_E/')
    ...
    x=oneway_anova_treatments(df=ends, col1='log_chaps_per_length*100', col2='Treatment')
    ...
    comp = mc.MultiComparison(ends['log_chaps_per_length*100'], ends['Treatment'])
    post_hoc_res = comp.tukeyhsd()
    summary=pd.DataFrame(post_hoc_res.summary())
    summary.to_csv(f'{inputu}ends_anova_tukeyhsd_summary.csv')
    
    #now compare between the middles
    x=oneway_anova_treatments(df=mids, col1='log_chaps_per_length*100', col2='Treatment')
    ...
    comp = mc.MultiComparison(mids['log_chaps_per_length*100'], mids['Treatment'])
    post_hoc_res = comp.tukeyhsd()
    summary=pd.DataFrame(post_hoc_res.summary())
